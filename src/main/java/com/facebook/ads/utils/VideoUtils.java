...
public class VideoUtils {
    ...
    public interface ProgressCallback {
        int EVENT_UPLOAD_PROGRESS = 0;
        int EVENT_UPLOAD_COMPLETE = 1;
        int EVENT_SERVER_ENCODING_PROGRESS = 2;
        int EVENT_SERVER_ENCODING_COMPLETE = 3;

        void onProgressUpdate(int event, int progress);
    }
