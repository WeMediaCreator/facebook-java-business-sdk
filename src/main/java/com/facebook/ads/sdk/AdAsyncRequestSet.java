...
public class AdAsyncRequestSet extends APINode {
    ...
    public AdAsyncRequestSet fetch() throws APIException {
        AdAsyncRequestSet newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestGetRequests getRequests() {
        return new APIRequestGetRequests(this.getPrefixedId(), context);
    }
    ...
    public enum EnumNotificationMode {
        ...
        EnumNotificationMode(String value) {
            this.value = value;
        }
    ...
    public enum EnumNotificationStatus {
        ...
        EnumNotificationStatus(String value) {
            this.value = value;
        }
