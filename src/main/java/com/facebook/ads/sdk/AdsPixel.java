...
public class AdsPixel extends APINode {
    ...
    public AdsPixel fetch() throws APIException {
        AdsPixel newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestDeleteSharedAccounts deleteSharedAccounts() {
        return new APIRequestDeleteSharedAccounts(this.getPrefixedId(), context);
    }

    public APIRequestGetSharedAccounts getSharedAccounts() {
        return new APIRequestGetSharedAccounts(this.getPrefixedId(), context);
    }

    public APIRequestCreateSharedAccount createSharedAccount() {
        return new APIRequestCreateSharedAccount(this.getPrefixedId(), context);
    }

    public APIRequestGetSharedAgencies getSharedAgencies() {
        return new APIRequestGetSharedAgencies(this.getPrefixedId(), context);
    }
    ...
    public enum EnumAutomaticMatchingFields {
        ...
        EnumAutomaticMatchingFields(String value) {
            this.value = value;
        }
    ...
    public enum EnumDataUseSetting {
        ...
        EnumDataUseSetting(String value) {
            this.value = value;
        }
    ...
    public enum EnumFirstPartyCookieStatus {
        ...
        EnumFirstPartyCookieStatus(String value) {
            this.value = value;
        }
