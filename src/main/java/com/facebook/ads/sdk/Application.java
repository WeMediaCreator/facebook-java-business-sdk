...
public class Application extends APINode {
    ...
    public Application fetch() throws APIException {
        Application newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestDeleteAccounts deleteAccounts() {
        return new APIRequestDeleteAccounts(this.getPrefixedId(), context);
    }

    public APIRequestGetAccounts getAccounts() {
        return new APIRequestGetAccounts(this.getPrefixedId(), context);
    }

    public APIRequestCreateAccount createAccount() {
        return new APIRequestCreateAccount(this.getPrefixedId(), context);
    }

    public APIRequestCreateActivity createActivity() {
        return new APIRequestCreateActivity(this.getPrefixedId(), context);
    }
    ...
    public APIRequestGetAndroidDialogConfigs getAndroidDialogConfigs() {
        return new APIRequestGetAndroidDialogConfigs(this.getPrefixedId(), context);
    }

    public APIRequestGetAppEventTypes getAppEventTypes() {
        return new APIRequestGetAppEventTypes(this.getPrefixedId(), context);
    }

    public APIRequestCreateAppIndexing createAppIndexing() {
        return new APIRequestCreateAppIndexing(this.getPrefixedId(), context);
    }

    public APIRequestCreateAppIndexingSession createAppIndexingSession() {
        return new APIRequestCreateAppIndexingSession(this.getPrefixedId(), context);
    }

    public APIRequestGetAppInsights getAppInsights() {
        return new APIRequestGetAppInsights(this.getPrefixedId(), context);
    }

    public APIRequestGetAppInstalledGroups getAppInstalledGroups() {
        return new APIRequestGetAppInstalledGroups(this.getPrefixedId(), context);
    }

    public APIRequestCreateAppPushDeviceToken createAppPushDeviceToken() {
        return new APIRequestCreateAppPushDeviceToken(this.getPrefixedId(), context);
    }

    public APIRequestGetAppAssets getAppAssets() {
        return new APIRequestGetAppAssets(this.getPrefixedId(), context);
    }

    public APIRequestCreateAsset createAsset() {
        return new APIRequestCreateAsset(this.getPrefixedId(), context);
    }

    public APIRequestGetAuthorizedAdAccounts getAuthorizedAdAccounts() {
        return new APIRequestGetAuthorizedAdAccounts(this.getPrefixedId(), context);
    }

    public APIRequestDeleteBanned deleteBanned() {
        return new APIRequestDeleteBanned(this.getPrefixedId(), context);
    }

    public APIRequestGetButtonAutoDetectionDeviceSelection getButtonAutoDetectionDeviceSelection() {
        return new APIRequestGetButtonAutoDetectionDeviceSelection(this.getPrefixedId(), context);
    }

    public APIRequestCreateButtonIndexing createButtonIndexing() {
        return new APIRequestCreateButtonIndexing(this.getPrefixedId(), context);
    }

    public APIRequestCreateCodelessEventMapping createCodelessEventMapping() {
        return new APIRequestCreateCodelessEventMapping(this.getPrefixedId(), context);
    }

    public APIRequestGetDaChecks getDaChecks() {
        return new APIRequestGetDaChecks(this.getPrefixedId(), context);
    }

    public APIRequestGetEvents getEvents() {
        return new APIRequestGetEvents(this.getPrefixedId(), context);
    }

    public APIRequestGetInsightsPushSchedule getInsightsPushSchedule() {
        return new APIRequestGetInsightsPushSchedule(this.getPrefixedId(), context);
    }

    public APIRequestCreateInsightsPushSchedule createInsightsPushSchedule() {
        return new APIRequestCreateInsightsPushSchedule(this.getPrefixedId(), context);
    }

    public APIRequestGetIosDialogConfigs getIosDialogConfigs() {
        return new APIRequestGetIosDialogConfigs(this.getPrefixedId(), context);
    }

    public APIRequestCreateLeaderboardsCreate createLeaderboardsCreate() {
        return new APIRequestCreateLeaderboardsCreate(this.getPrefixedId(), context);
    }

    public APIRequestCreateLeaderboardsDeleteEntry createLeaderboardsDeleteEntry() {
        return new APIRequestCreateLeaderboardsDeleteEntry(this.getPrefixedId(), context);
    }

    public APIRequestCreateLeaderboardsReset createLeaderboardsReset() {
        return new APIRequestCreateLeaderboardsReset(this.getPrefixedId(), context);
    }

    public APIRequestCreateLeaderboardsSetScore createLeaderboardsSetScore() {
        return new APIRequestCreateLeaderboardsSetScore(this.getPrefixedId(), context);
    }

    public APIRequestGetLiveVideos getLiveVideos() {
        return new APIRequestGetLiveVideos(this.getPrefixedId(), context);
    }

    public APIRequestCreateMmpAuditing createMmpAuditing() {
        return new APIRequestCreateMmpAuditing(this.getPrefixedId(), context);
    }

    public APIRequestGetMobileSdkGk getMobileSdkGk() {
        return new APIRequestGetMobileSdkGk(this.getPrefixedId(), context);
    }

    public APIRequestCreateOccludesPopup createOccludesPopup() {
        return new APIRequestCreateOccludesPopup(this.getPrefixedId(), context);
    }

    public APIRequestGetOzoneRelease getOzoneRelease() {
        return new APIRequestGetOzoneRelease(this.getPrefixedId(), context);
    }

    public APIRequestCreatePageActivity createPageActivity() {
        return new APIRequestCreatePageActivity(this.getPrefixedId(), context);
    }

    public APIRequestDeletePaymentCurrencies deletePaymentCurrencies() {
        return new APIRequestDeletePaymentCurrencies(this.getPrefixedId(), context);
    }

    public APIRequestCreatePaymentCurrency createPaymentCurrency() {
        return new APIRequestCreatePaymentCurrency(this.getPrefixedId(), context);
    }

    public APIRequestGetPermissions getPermissions() {
        return new APIRequestGetPermissions(this.getPrefixedId(), context);
    }

    public APIRequestGetProducts getProducts() {
        return new APIRequestGetProducts(this.getPrefixedId(), context);
    }

    public APIRequestGetPurchases getPurchases() {
        return new APIRequestGetPurchases(this.getPrefixedId(), context);
    }

    public APIRequestGetRoles getRoles() {
        return new APIRequestGetRoles(this.getPrefixedId(), context);
    }

    public APIRequestGetSubscribedDomains getSubscribedDomains() {
        return new APIRequestGetSubscribedDomains(this.getPrefixedId(), context);
    }

    public APIRequestCreateSubscribedDomain createSubscribedDomain() {
        return new APIRequestCreateSubscribedDomain(this.getPrefixedId(), context);
    }

    public APIRequestGetSubscribedDomainsPhishing getSubscribedDomainsPhishing() {
        return new APIRequestGetSubscribedDomainsPhishing(this.getPrefixedId(), context);
    }

    public APIRequestCreateSubscribedDomainsPhishing createSubscribedDomainsPhishing() {
        return new APIRequestCreateSubscribedDomainsPhishing(this.getPrefixedId(), context);
    }

    public APIRequestDeleteSubscriptions deleteSubscriptions() {
        return new APIRequestDeleteSubscriptions(this.getPrefixedId(), context);
    }

    public APIRequestCreateSubscription createSubscription() {
        return new APIRequestCreateSubscription(this.getPrefixedId(), context);
    }

    public APIRequestCreateUpload createUpload() {
        return new APIRequestCreateUpload(this.getPrefixedId(), context);
    }

    public APIRequestCreateUserProperty createUserProperty() {
        return new APIRequestCreateUserProperty(this.getPrefixedId(), context);
    }
    ...
    public enum EnumSupportedPlatforms {
        ...
        EnumSupportedPlatforms(String value) {
            this.value = value;
        }
    ...
    public enum EnumMutationMethod {
        ...
        EnumMutationMethod(String value) {
            this.value = value;
        }
    ...
    public enum EnumLoggingSource {
        ...
        EnumLoggingSource(String value) {
            this.value = value;
        }
    ...
    public enum EnumLoggingTarget {
        ...
        EnumLoggingTarget(String value) {
            this.value = value;
        }
