...
public class AdRule extends APINode {
    ...
    public AdRule fetch() throws APIException {
        AdRule newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestCreateExecute createExecute() {
        return new APIRequestCreateExecute(this.getPrefixedId(), context);
    }

    public APIRequestGetHistory getHistory() {
        return new APIRequestGetHistory(this.getPrefixedId(), context);
    }

    public APIRequestCreatePreview createPreview() {
        return new APIRequestCreatePreview(this.getPrefixedId(), context);
    }
