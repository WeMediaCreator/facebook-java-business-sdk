...
public class PageCallToAction extends APINode {
    ...
    public PageCallToAction fetch() throws APIException {
        PageCallToAction newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public enum EnumAndroidDestinationType {
        ...
        EnumAndroidDestinationType(String value) {
            this.value = value;
        }
    ...
    public enum EnumIphoneDestinationType {
        @SerializedName("APP_DEEPLINK")
        VALUE_APP_DEEPLINK("APP_DEEPLINK"),
        @SerializedName("BECOME_A_VOLUNTEER")
        VALUE_BECOME_A_VOLUNTEER("BECOME_A_VOLUNTEER"),
        ...
        EnumIphoneDestinationType(String value) {
            this.value = value;
        }
    ...
    public enum EnumWebDestinationType {
        @SerializedName("BECOME_A_VOLUNTEER")
        VALUE_BECOME_A_VOLUNTEER("BECOME_A_VOLUNTEER"),
        ...
        EnumWebDestinationType(String value) {
            this.value = value;
        }
