...
public class Vehicle extends APINode {
    ...
    public Vehicle fetch() throws APIException {
        Vehicle newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public enum EnumStateOfVehicle {
        @SerializedName("CPO")
        VALUE_CPO("CPO"),
        @SerializedName("NEW")
        VALUE_NEW("NEW"),
        ...
        EnumStateOfVehicle(String value) {
            this.value = value;
        }
