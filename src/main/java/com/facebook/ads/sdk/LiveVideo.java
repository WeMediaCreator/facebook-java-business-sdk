...
public class LiveVideo extends APINode {
    ...
    public LiveVideo fetch() throws APIException {
        LiveVideo newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestGetBlockedUsers getBlockedUsers() {
        return new APIRequestGetBlockedUsers(this.getPrefixedId(), context);
    }
    ...
    public APIRequestGetCrosspostedBroadcasts getCrosspostedBroadcasts() {
        return new APIRequestGetCrosspostedBroadcasts(this.getPrefixedId(), context);
    }

    public APIRequestGetErrors getErrors() {
        return new APIRequestGetErrors(this.getPrefixedId(), context);
    }

    public APIRequestCreateInputStream createInputStream() {
        return new APIRequestCreateInputStream(this.getPrefixedId(), context);
    }
    ...
    public enum EnumBroadcastStatus {
        ...
        EnumBroadcastStatus(String value) {
            this.value = value;
        }
    ...
    public enum EnumSpatialAudioFormat {
        ...
        EnumSpatialAudioFormat(String value) {
            this.value = value;
        }
    ...
    public enum EnumStereoscopicMode {
        ...
        EnumStereoscopicMode(String value) {
            this.value = value;
        }
    ...
    public enum EnumLiveCommentModerationSetting {
        ...
        EnumLiveCommentModerationSetting(String value) {
            this.value = value;
        }
