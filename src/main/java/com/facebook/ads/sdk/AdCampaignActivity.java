...
public class AdCampaignActivity extends APINode {
    ...
    public AdCampaignActivity fetch() throws APIException {
        AdCampaignActivity newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public enum EnumBidStrategyNew {
        ...
        EnumBidStrategyNew(String value) {
            this.value = value;
        }
    ...
    public enum EnumBidStrategyOld {
        ...
        EnumBidStrategyOld(String value) {
            this.value = value;
        }
    ...
    public enum EnumBillingEventNew {
        ...
        EnumBillingEventNew(String value) {
            this.value = value;
        }
    ...
    public enum EnumBillingEventOld {
        ...
        EnumBillingEventOld(String value) {
            this.value = value;
        }
    ...
    public enum EnumOptimizationGoalNew {
        ...
        EnumOptimizationGoalNew(String value) {
            this.value = value;
        }
    ...
    public enum EnumOptimizationGoalOld {
        ...
        EnumOptimizationGoalOld(String value) {
            this.value = value;
        }
