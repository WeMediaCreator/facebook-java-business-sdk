...
public class AtlasCampaign extends APINode {
    ...
    public AtlasCampaign fetch() throws APIException {
        AtlasCampaign newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestGetBusinessUnit getBusinessUnit() {
        return new APIRequestGetBusinessUnit(this.getPrefixedId(), context);
    }

    public APIRequestGetMetricsBreakdown getMetricsBreakdown() {
        return new APIRequestGetMetricsBreakdown(this.getPrefixedId(), context);
    }
