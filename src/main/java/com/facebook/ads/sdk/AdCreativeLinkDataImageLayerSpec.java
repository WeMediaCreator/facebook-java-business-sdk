...
public class AdCreativeLinkDataImageLayerSpec extends APINode {
    ...
    public enum EnumOverlayPosition {
        ...
        EnumOverlayPosition(String value) {
            this.value = value;
        }
