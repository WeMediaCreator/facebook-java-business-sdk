...
public class IGUser extends APINode {
    ...
    public IGUser fetch() throws APIException {
        IGUser newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestGetMedia getMedia() {
        return new APIRequestGetMedia(this.getPrefixedId(), context);
    }

    public APIRequestCreateMedia createMedia() {
        return new APIRequestCreateMedia(this.getPrefixedId(), context);
    }

    public APIRequestCreateMediaPublish createMediaPublish() {
        return new APIRequestCreateMediaPublish(this.getPrefixedId(), context);
    }

    public APIRequestCreateMention createMention() {
        return new APIRequestCreateMention(this.getPrefixedId(), context);
    }

    public APIRequestGetRecentlySearchedHashtags getRecentlySearchedHashtags() {
        return new APIRequestGetRecentlySearchedHashtags(this.getPrefixedId(), context);
    }

    public APIRequestGetStories getStories() {
        return new APIRequestGetStories(this.getPrefixedId(), context);
    }
