...
public class Group extends APINode {
    ...
    public Group fetch() throws APIException {
        Group newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestDeleteAdmins deleteAdmins() {
        return new APIRequestDeleteAdmins(this.getPrefixedId(), context);
    }

    public APIRequestCreateAdmin createAdmin() {
        return new APIRequestCreateAdmin(this.getPrefixedId(), context);
    }
    ...
    public APIRequestCreateAlbum createAlbum() {
        return new APIRequestCreateAlbum(this.getPrefixedId(), context);
    }

    public APIRequestGetDocs getDocs() {
        return new APIRequestGetDocs(this.getPrefixedId(), context);
    }
    ...
    public APIRequestCreateGroup createGroup() {
        return new APIRequestCreateGroup(this.getPrefixedId(), context);
    }
    ...
    public APIRequestDeleteMembers deleteMembers() {
        return new APIRequestDeleteMembers(this.getPrefixedId(), context);
    }

    public APIRequestCreateMember createMember() {
        return new APIRequestCreateMember(this.getPrefixedId(), context);
    }

    public APIRequestGetOptedInMembers getOptedInMembers() {
        return new APIRequestGetOptedInMembers(this.getPrefixedId(), context);
    }
    ...
    public enum EnumPostPermissions {
        ...
        EnumPostPermissions(String value) {
            this.value = value;
        }
    ...
    public enum EnumSuggestionCategory {
        ...
        EnumSuggestionCategory(String value) {
            this.value = value;
        }
