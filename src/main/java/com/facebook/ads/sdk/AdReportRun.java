...
public class AdReportRun extends APINode {
    ...
    public AdReportRun fetch() throws APIException {
        AdReportRun newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public enum EnumActionAttributionWindows {
        ...
        EnumActionAttributionWindows(String value) {
            this.value = value;
        }
    ...
    public enum EnumActionBreakdowns {
        ...
        EnumActionBreakdowns(String value) {
            this.value = value;
        }
    ...
    public enum EnumActionReportTime {
        ...
        EnumActionReportTime(String value) {
            this.value = value;
        }
    ...
    public enum EnumSummaryActionBreakdowns {
        ...
        EnumSummaryActionBreakdowns(String value) {
            this.value = value;
        }
