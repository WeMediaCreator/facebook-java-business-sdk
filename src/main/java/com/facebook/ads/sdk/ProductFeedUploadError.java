...
public class ProductFeedUploadError extends APINode {
    ...
    public ProductFeedUploadError fetch() throws APIException {
        ProductFeedUploadError newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestGetSamples getSamples() {
        return new APIRequestGetSamples(this.getPrefixedId(), context);
    }

    public APIRequestGetSuggestedRules getSuggestedRules() {
        return new APIRequestGetSuggestedRules(this.getPrefixedId(), context);
    }
    ...
    public enum EnumAffectedSurfaces {
        ...
        EnumAffectedSurfaces(String value) {
            this.value = value;
        }
