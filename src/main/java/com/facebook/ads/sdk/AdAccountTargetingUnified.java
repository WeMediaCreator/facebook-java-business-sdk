...
public class AdAccountTargetingUnified extends APINode {
    ...
    public enum EnumRegulatedCategories {
        ...
        EnumRegulatedCategories(String value) {
            this.value = value;
        }
    ...
    public enum EnumWhitelistedTypes {
        ...
        EnumWhitelistedTypes(String value) {
            this.value = value;
        }
