...
public class AdVideo extends APINode {
    ...
    public AdVideo fetch() throws APIException {
        AdVideo newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestGetCaptions getCaptions() {
        return new APIRequestGetCaptions(this.getPrefixedId(), context);
    }

    public APIRequestCreateCaption createCaption() {
        return new APIRequestCreateCaption(this.getPrefixedId(), context);
    }

    public APIRequestGetComments getComments() {
        return new APIRequestGetComments(this.getPrefixedId(), context);
    }

    public APIRequestCreateComment createComment() {
        return new APIRequestCreateComment(this.getPrefixedId(), context);
    }

    public APIRequestGetCrosspostSharedPages getCrosspostSharedPages() {
        return new APIRequestGetCrosspostSharedPages(this.getPrefixedId(), context);
    }
    ...
    public APIRequestCreateLike createLike() {
        return new APIRequestCreateLike(this.getPrefixedId(), context);
    }

    public APIRequestGetPollSettings getPollSettings() {
        return new APIRequestGetPollSettings(this.getPrefixedId(), context);
    }

    public APIRequestGetPolls getPolls() {
        return new APIRequestGetPolls(this.getPrefixedId(), context);
    }

    public APIRequestCreatePoll createPoll() {
        return new APIRequestCreatePoll(this.getPrefixedId(), context);
    }

    public APIRequestGetReactions getReactions() {
        return new APIRequestGetReactions(this.getPrefixedId(), context);
    }

    public APIRequestGetSharedPosts getSharedPosts() {
        return new APIRequestGetSharedPosts(this.getPrefixedId(), context);
    }

    public APIRequestGetSponsorTags getSponsorTags() {
        return new APIRequestGetSponsorTags(this.getPrefixedId(), context);
    }

    public APIRequestGetTags getTags() {
        return new APIRequestGetTags(this.getPrefixedId(), context);
    }

    public APIRequestCreateTag createTag() {
        return new APIRequestCreateTag(this.getPrefixedId(), context);
    }

    public APIRequestGetThumbnails getThumbnails() {
        return new APIRequestGetThumbnails(this.getPrefixedId(), context);
    }

    public APIRequestCreateThumbnail createThumbnail() {
        return new APIRequestCreateThumbnail(this.getPrefixedId(), context);
    }

    public APIRequestGetVideoInsights getVideoInsights() {
        return new APIRequestGetVideoInsights(this.getPrefixedId(), context);
    }
    ...
    public enum EnumContainerType {
        ...
        EnumContainerType(String value) {
            this.value = value;
        }
    ...
    public enum EnumContentCategory {
        ...
        EnumContentCategory(String value) {
            this.value = value;
        }
    ...
    public enum EnumOriginalProjectionType {
        ...
        EnumOriginalProjectionType(String value) {
            this.value = value;
        }
