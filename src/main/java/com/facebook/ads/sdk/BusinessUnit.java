...
public class BusinessUnit extends APINode {
    ...
    public BusinessUnit fetch() throws APIException {
        BusinessUnit newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestGetAdPlatforms getAdPlatforms() {
        return new APIRequestGetAdPlatforms(this.getPrefixedId(), context);
    }

    public APIRequestGetAtlasSalesAccesses getAtlasSalesAccesses() {
        return new APIRequestGetAtlasSalesAccesses(this.getPrefixedId(), context);
    }

    public APIRequestCreateAtlasSalesAccess createAtlasSalesAccess() {
        return new APIRequestCreateAtlasSalesAccess(this.getPrefixedId(), context);
    }

    public APIRequestGetCampaigns getCampaigns() {
        return new APIRequestGetCampaigns(this.getPrefixedId(), context);
    }

    public APIRequestGetConversionEvents getConversionEvents() {
        return new APIRequestGetConversionEvents(this.getPrefixedId(), context);
    }

    public APIRequestGetConversionPaths getConversionPaths() {
        return new APIRequestGetConversionPaths(this.getPrefixedId(), context);
    }

    public APIRequestGetCustomBreakdowns getCustomBreakdowns() {
        return new APIRequestGetCustomBreakdowns(this.getPrefixedId(), context);
    }

    public APIRequestGetDiagnostics getDiagnostics() {
        return new APIRequestGetDiagnostics(this.getPrefixedId(), context);
    }

    public APIRequestGetExternalImportFile getExternalImportFile() {
        return new APIRequestGetExternalImportFile(this.getPrefixedId(), context);
    }

    public APIRequestGetReports getReports() {
        return new APIRequestGetReports(this.getPrefixedId(), context);
    }

    public APIRequestGetSources getSources() {
        return new APIRequestGetSources(this.getPrefixedId(), context);
    }

    public APIRequestGetUsers getUsers() {
        return new APIRequestGetUsers(this.getPrefixedId(), context);
    }
