...
public class NativeOffer extends APINode {
    ...
    public NativeOffer fetch() throws APIException {
        NativeOffer newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestCreateCode createCode() {
        return new APIRequestCreateCode(this.getPrefixedId(), context);
    }

    public APIRequestCreateNativeOfferView createNativeOfferView() {
        return new APIRequestCreateNativeOfferView(this.getPrefixedId(), context);
    }

    public APIRequestGetViews getViews() {
        return new APIRequestGetViews(this.getPrefixedId(), context);
    }
    ...
    public enum EnumUniqueCodesFileCodeType {
        ...
        EnumUniqueCodesFileCodeType(String value) {
            this.value = value;
        }
