...
public class PageUserMessageThreadLabel extends APINode {
    ...
    public PageUserMessageThreadLabel fetch() throws APIException {
        PageUserMessageThreadLabel newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestDeleteLabel deleteLabel() {
        return new APIRequestDeleteLabel(this.getPrefixedId(), context);
    }

    public APIRequestCreateLabel createLabel() {
        return new APIRequestCreateLabel(this.getPrefixedId(), context);
    }
