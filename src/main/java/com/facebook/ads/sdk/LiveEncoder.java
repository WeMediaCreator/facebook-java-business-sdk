...
public class LiveEncoder extends APINode {
    ...
    public LiveEncoder fetch() throws APIException {
        LiveEncoder newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestCreateTelemetry createTelemetry() {
        return new APIRequestCreateTelemetry(this.getPrefixedId(), context);
    }
    ...
    public enum EnumCapAudioCodecs {
        ...
        EnumCapAudioCodecs(String value) {
            this.value = value;
        }
    ...
    public enum EnumCapStreamingProtocols {
        ...
        EnumCapStreamingProtocols(String value) {
            this.value = value;
        }
    ...
    public enum EnumCapVideoCodecs {
        ...
        EnumCapVideoCodecs(String value) {
            this.value = value;
        }
