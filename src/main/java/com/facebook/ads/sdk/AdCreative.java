...
public class AdCreative extends APINode {
    ...
    public AdCreative fetch() throws APIException {
        AdCreative newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestGetCreativeInsights getCreativeInsights() {
        return new APIRequestGetCreativeInsights(this.getPrefixedId(), context);
    }
    ...
    public AdCreative setFieldAssetFeedSpec(String value) {
        Type type = new TypeToken<AdAssetFeedSpec>() {
        }.getType();
    ...
    public AdCreative setFieldInteractiveComponentsSpec(String value) {
        Type type = new TypeToken<AdCreativeInteractiveComponentsSpec>() {
        }.getType();
    ...
    public AdCreative setFieldPlatformCustomizations(String value) {
        Type type = new TypeToken<AdCreativePlatformCustomization>() {
        }.getType();
    ...
    public AdCreative setFieldPortraitCustomizations(String value) {
        Type type = new TypeToken<AdCreativePortraitCustomizations>() {
        }.getType();
    ...
    public AdCreative setFieldRecommenderSettings(String value) {
        Type type = new TypeToken<AdCreativeRecommenderSettings>() {
        }.getType();
    ...
    public AdCreative setFieldTemplateUrlSpec(String value) {
        Type type = new TypeToken<AdCreativeTemplateURLSpec>() {
        }.getType();
    ...
    public enum EnumApplinkTreatment {
        ...
        EnumApplinkTreatment(String value) {
            this.value = value;
        }
    ...
    public enum EnumCallToActionType {
        ...
        EnumCallToActionType(String value) {
            this.value = value;
        }
    ...
    public enum EnumAuthorizationCategory {
        ...
        EnumAuthorizationCategory(String value) {
            this.value = value;
        }
    ...
    public enum EnumCategorizationCriteria {
        ...
        EnumCategorizationCriteria(String value) {
            this.value = value;
        }
    ...
    public enum EnumCategoryMediaSource {
        ...
        EnumCategoryMediaSource(String value) {
            this.value = value;
        }
    ...
    public enum EnumDynamicAdVoice {
        ...
        EnumDynamicAdVoice(String value) {
            this.value = value;
        }
    ...
    public enum EnumInstantCheckoutSetting {
        ...
        EnumInstantCheckoutSetting(String value) {
            this.value = value;
        }
