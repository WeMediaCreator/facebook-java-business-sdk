...
public class IGComment extends APINode {
    ...
    public IGComment fetch() throws APIException {
        IGComment newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestGetReplies getReplies() {
        return new APIRequestGetReplies(this.getPrefixedId(), context);
    }

    public APIRequestCreateReply createReply() {
        return new APIRequestCreateReply(this.getPrefixedId(), context);
    }
