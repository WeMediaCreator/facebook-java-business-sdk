...
public class Ad extends APINode {
    ...
    public Ad fetch() throws APIException {
        Ad newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestGetLeads getLeads() {
        return new APIRequestGetLeads(this.getPrefixedId(), context);
    }

    public APIRequestGetPreviews getPreviews() {
        return new APIRequestGetPreviews(this.getPrefixedId(), context);
    }
