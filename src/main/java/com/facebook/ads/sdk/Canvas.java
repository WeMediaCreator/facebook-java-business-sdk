...
public class Canvas extends APINode {
    ...
    public Canvas fetch() throws APIException {
        Canvas newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestCreateDuplicateCanva createDuplicateCanva() {
        return new APIRequestCreateDuplicateCanva(this.getPrefixedId(), context);
    }

    public APIRequestCreatePreviewNotification createPreviewNotification() {
        return new APIRequestCreatePreviewNotification(this.getPrefixedId(), context);
    }
