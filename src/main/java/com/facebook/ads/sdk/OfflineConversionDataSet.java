...
public class OfflineConversionDataSet extends APINode {
    ...
    public OfflineConversionDataSet fetch() throws APIException {
        OfflineConversionDataSet newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestGetAudiences getAudiences() {
        return new APIRequestGetAudiences(this.getPrefixedId(), context);
    }

    public APIRequestGetCustomConversions getCustomConversions() {
        return new APIRequestGetCustomConversions(this.getPrefixedId(), context);
    }

    public APIRequestCreateEvent createEvent() {
        return new APIRequestCreateEvent(this.getPrefixedId(), context);
    }

    public APIRequestGetStats getStats() {
        return new APIRequestGetStats(this.getPrefixedId(), context);
    }
    ...
    public APIRequestCreateValidate createValidate() {
        return new APIRequestCreateValidate(this.getPrefixedId(), context);
    }
    ...
    public enum EnumRelationshipType {
        ...
        EnumRelationshipType(String value) {
            this.value = value;
        }
