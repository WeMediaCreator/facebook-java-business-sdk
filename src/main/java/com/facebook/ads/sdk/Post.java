...
public class Post extends APINode {
    ...
    public Post fetch() throws APIException {
        Post newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestGetAttachments getAttachments() {
        return new APIRequestGetAttachments(this.getPrefixedId(), context);
    }
    ...
    public APIRequestGetDynamicPosts getDynamicPosts() {
        return new APIRequestGetDynamicPosts(this.getPrefixedId(), context);
    }
    ...
    public APIRequestDeleteLikes deleteLikes() {
        return new APIRequestDeleteLikes(this.getPrefixedId(), context);
    }
    ...
    public APIRequestCreatePromotion createPromotion() {
        return new APIRequestCreatePromotion(this.getPrefixedId(), context);
    }
    ...
    public APIRequestGetTo getTo() {
        return new APIRequestGetTo(this.getPrefixedId(), context);
    }
    ...
    public enum EnumFeedStoryVisibility {
        ...
        EnumFeedStoryVisibility(String value) {
            this.value = value;
        }
    ...
    public enum EnumTimelineVisibility {
        ...
        EnumTimelineVisibility(String value) {
            this.value = value;
        }
