...
public class BusinessAssetGroup extends APINode {
    ...
    public BusinessAssetGroup fetch() throws APIException {
        BusinessAssetGroup newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestDeleteContainedAdAccounts deleteContainedAdAccounts() {
        return new APIRequestDeleteContainedAdAccounts(this.getPrefixedId(), context);
    }

    public APIRequestGetContainedAdAccounts getContainedAdAccounts() {
        return new APIRequestGetContainedAdAccounts(this.getPrefixedId(), context);
    }

    public APIRequestCreateContainedAdAccount createContainedAdAccount() {
        return new APIRequestCreateContainedAdAccount(this.getPrefixedId(), context);
    }

    public APIRequestDeleteContainedApplications deleteContainedApplications() {
        return new APIRequestDeleteContainedApplications(this.getPrefixedId(), context);
    }

    public APIRequestGetContainedApplications getContainedApplications() {
        return new APIRequestGetContainedApplications(this.getPrefixedId(), context);
    }

    public APIRequestCreateContainedApplication createContainedApplication() {
        return new APIRequestCreateContainedApplication(this.getPrefixedId(), context);
    }

    public APIRequestDeleteContainedCustomConversions deleteContainedCustomConversions() {
        return new APIRequestDeleteContainedCustomConversions(this.getPrefixedId(), context);
    }

    public APIRequestGetContainedCustomConversions getContainedCustomConversions() {
        return new APIRequestGetContainedCustomConversions(this.getPrefixedId(), context);
    }

    public APIRequestCreateContainedCustomConversion createContainedCustomConversion() {
        return new APIRequestCreateContainedCustomConversion(this.getPrefixedId(), context);
    }

    public APIRequestDeleteContainedInstagramAccounts deleteContainedInstagramAccounts() {
        return new APIRequestDeleteContainedInstagramAccounts(this.getPrefixedId(), context);
    }

    public APIRequestGetContainedInstagramAccounts getContainedInstagramAccounts() {
        return new APIRequestGetContainedInstagramAccounts(this.getPrefixedId(), context);
    }

    public APIRequestCreateContainedInstagramAccount createContainedInstagramAccount() {
        return new APIRequestCreateContainedInstagramAccount(this.getPrefixedId(), context);
    }

    public APIRequestDeleteContainedOfflineConversionDataSets deleteContainedOfflineConversionDataSets() {
        return new APIRequestDeleteContainedOfflineConversionDataSets(this.getPrefixedId(), context);
    }

    public APIRequestGetContainedOfflineConversionDataSets getContainedOfflineConversionDataSets() {
        return new APIRequestGetContainedOfflineConversionDataSets(this.getPrefixedId(), context);
    }

    public APIRequestCreateContainedOfflineConversionDataSet createContainedOfflineConversionDataSet() {
        return new APIRequestCreateContainedOfflineConversionDataSet(this.getPrefixedId(), context);
    }

    public APIRequestDeleteContainedPages deleteContainedPages() {
        return new APIRequestDeleteContainedPages(this.getPrefixedId(), context);
    }

    public APIRequestGetContainedPages getContainedPages() {
        return new APIRequestGetContainedPages(this.getPrefixedId(), context);
    }

    public APIRequestCreateContainedPage createContainedPage() {
        return new APIRequestCreateContainedPage(this.getPrefixedId(), context);
    }

    public APIRequestDeleteContainedPixels deleteContainedPixels() {
        return new APIRequestDeleteContainedPixels(this.getPrefixedId(), context);
    }

    public APIRequestGetContainedPixels getContainedPixels() {
        return new APIRequestGetContainedPixels(this.getPrefixedId(), context);
    }

    public APIRequestCreateContainedPixel createContainedPixel() {
        return new APIRequestCreateContainedPixel(this.getPrefixedId(), context);
    }

    public APIRequestDeleteContainedProductCatalogs deleteContainedProductCatalogs() {
        return new APIRequestDeleteContainedProductCatalogs(this.getPrefixedId(), context);
    }

    public APIRequestGetContainedProductCatalogs getContainedProductCatalogs() {
        return new APIRequestGetContainedProductCatalogs(this.getPrefixedId(), context);
    }

    public APIRequestCreateContainedProductCatalog createContainedProductCatalog() {
        return new APIRequestCreateContainedProductCatalog(this.getPrefixedId(), context);
    }
    ...
    public enum EnumAdaccountTasks {
        ...
        EnumAdaccountTasks(String value) {
            this.value = value;
        }
    ...
    public enum EnumOfflineConversionDataSetTasks {
        ...
        EnumOfflineConversionDataSetTasks(String value) {
            this.value = value;
        }
