...
public class ExtendedCreditAllocationConfig extends APINode {
    ...
    public ExtendedCreditAllocationConfig fetch() throws APIException {
        ExtendedCreditAllocationConfig newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public enum EnumLiabilityType {
        ...
        EnumLiabilityType(String value) {
            this.value = value;
        }
    ...
    public enum EnumPartitionType {
        ...
        EnumPartitionType(String value) {
            this.value = value;
        }
