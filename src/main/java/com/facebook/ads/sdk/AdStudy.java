...
public class AdStudy extends APINode {
    ...
    public AdStudy fetch() throws APIException {
        AdStudy newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestGetCells getCells() {
        return new APIRequestGetCells(this.getPrefixedId(), context);
    }

    public APIRequestGetObjectives getObjectives() {
        return new APIRequestGetObjectives(this.getPrefixedId(), context);
    }

    public APIRequestCreateObjective createObjective() {
        return new APIRequestCreateObjective(this.getPrefixedId(), context);
    }
