...
public class AdCreativeLinkData extends APINode {
    ...
    public AdCreativeLinkData setFieldCollectionThumbnails(String value) {
        Type type = new TypeToken<List<AdCreativeCollectionThumbnailInfo>>() {
        }.getType();
    ...
    public AdCreativeLinkData setFieldCustomizationRulesSpec(String value) {
        Type type = new TypeToken<List<AdCustomizationRuleSpec>>() {
        }.getType();
    ...
    public AdCreativeLinkData setFieldImageLayerSpecs(String value) {
        Type type = new TypeToken<List<AdCreativeLinkDataImageLayerSpec>>() {
        }.getType();
    ...
    public AdCreativeLinkData setFieldImageOverlaySpec(String value) {
        Type type = new TypeToken<AdCreativeLinkDataImageOverlaySpec>() {
        }.getType();
    ...
    public AdCreativeLinkData setFieldPostClickConfiguration(String value) {
        Type type = new TypeToken<AdCreativePostClickConfiguration>() {
        }.getType();
    ...
    public AdCreativeLinkData setFieldStaticFallbackSpec(String value) {
        Type type = new TypeToken<AdCreativeStaticFallbackSpec>() {
        }.getType();
    ...
    public enum EnumAttachmentStyle {
        ...
        EnumAttachmentStyle(String value) {
            this.value = value;
        }
