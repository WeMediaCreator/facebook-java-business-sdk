...
public class APIRequest<T extends APINode> {
  ...
  public APIRequest<T> setParam(String param, Object value) {
        ...
        if (this.method.equals("POST")) {
            ...
            for (Map.Entry entry : allParams.entrySet()) {
                if (entry.getValue() instanceof File) {
                    ...
                    body.append((firstEntry ? "" : "&") + URLEncoder.encode(entry.getKey().toString(), StandardCharsets.UTF_8) + "=" + URLEncoder.encode(convertToString(entry.getValue()), StandardCharsets.UTF_8));
                    firstEntry = false;
                }
            }
            ...
            boolean firstEntry = true;
            for (Map.Entry entry : allParams.entrySet()) {
                relativeUrl.append((firstEntry ? "?" : "&") + URLEncoder.encode(entry.getKey().toString(), StandardCharsets.UTF_8) + "=" + URLEncoder.encode(convertToString(entry.getValue()), StandardCharsets.UTF_8));
                firstEntry = false;
            }
            info.relativeUrl = relativeUrl.toString();
        }
    ...
    public interface IRequestExecutor {
        ResponseWrapper execute(String method, String apiUrl, Map<String, Object> allParams, APIContext context) throws APIException, IOException;

        ResponseWrapper sendGet(String apiUrl, Map<String, Object> allParams, APIContext context) throws APIException, IOException;

        ResponseWrapper sendPost(String apiUrl, Map<String, Object> allParams, APIContext context) throws APIException, IOException;

        ResponseWrapper sendDelete(String apiUrl, Map<String, Object> allParams, APIContext context) throws APIException, IOException;
    }

    public interface IAsyncRequestExecutor {
        ListenableFuture<ResponseWrapper> execute(String method, String apiUrl, Map<String, Object> allParams, APIContext context) throws APIException, IOException;

        ListenableFuture<ResponseWrapper> sendGet(String apiUrl, Map<String, Object> allParams, APIContext context) throws APIException, IOException;

        ListenableFuture<ResponseWrapper> sendPost(String apiUrl, Map<String, Object> allParams, APIContext context) throws APIException, IOException;

        ListenableFuture<ResponseWrapper> sendDelete(String apiUrl, Map<String, Object> allParams, APIContext context) throws APIException, IOException;
    }
    ...
    public static class RequestHelper {
        ...
        public static String constructUrlString(String apiUrl, Map<String, Object> allParams) throws IOException {
            ...
            boolean firstEntry = true;
            for (Map.Entry entry : allParams.entrySet()) {
                urlString.append((firstEntry ? "?" : "&") + URLEncoder.encode(entry.getKey().toString(), StandardCharsets.UTF_8) + "=" + URLEncoder.encode(convertToString(entry.getValue()), StandardCharsets.UTF_8));
                firstEntry = false;
            }
