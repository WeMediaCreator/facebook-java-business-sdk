...
public class Comment extends APINode {
    ...
    public Comment fetch() throws APIException {
        Comment newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public enum EnumCommentPrivacyValue {
        ...
        EnumCommentPrivacyValue(String value) {
            this.value = value;
        }
