...
public class CommerceMerchantSettings extends APINode {
    ...
    public CommerceMerchantSettings fetch() throws APIException {
        CommerceMerchantSettings newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestCreateFacebookChannel createFacebookChannel() {
        return new APIRequestCreateFacebookChannel(this.getPrefixedId(), context);
    }

    public APIRequestDeleteInstagramChannel deleteInstagramChannel() {
        return new APIRequestDeleteInstagramChannel(this.getPrefixedId(), context);
    }

    public APIRequestCreateInstagramChannel createInstagramChannel() {
        return new APIRequestCreateInstagramChannel(this.getPrefixedId(), context);
    }

    public APIRequestGetOrderManagementApps getOrderManagementApps() {
        return new APIRequestGetOrderManagementApps(this.getPrefixedId(), context);
    }

    public APIRequestCreateOrderManagementApp createOrderManagementApp() {
        return new APIRequestCreateOrderManagementApp(this.getPrefixedId(), context);
    }

    public APIRequestGetProductCatalogs getProductCatalogs() {
        return new APIRequestGetProductCatalogs(this.getPrefixedId(), context);
    }

    public APIRequestGetReturns getReturns() {
        return new APIRequestGetReturns(this.getPrefixedId(), context);
    }

    public APIRequestGetSetupStatus getSetupStatus() {
        return new APIRequestGetSetupStatus(this.getPrefixedId(), context);
    }

    public APIRequestGetShippingProfiles getShippingProfiles() {
        return new APIRequestGetShippingProfiles(this.getPrefixedId(), context);
    }

    public APIRequestCreateShippingProfile createShippingProfile() {
        return new APIRequestCreateShippingProfile(this.getPrefixedId(), context);
    }

    public APIRequestGetTaxSettings getTaxSettings() {
        return new APIRequestGetTaxSettings(this.getPrefixedId(), context);
    }

    public APIRequestCreateWhatsappChannel createWhatsappChannel() {
        return new APIRequestCreateWhatsappChannel(this.getPrefixedId(), context);
    }
    ...
    public enum EnumMerchantStatus {
        ...
        EnumMerchantStatus(String value) {
            this.value = value;
        }
