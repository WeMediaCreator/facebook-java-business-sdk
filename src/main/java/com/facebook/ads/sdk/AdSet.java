...
public class AdSet extends APINode {
    ...
    public AdSet fetch() throws APIException {
        AdSet newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestGetActivities getActivities() {
        return new APIRequestGetActivities(this.getPrefixedId(), context);
    }
    ...
    public APIRequestGetAdCreatives getAdCreatives() {
        return new APIRequestGetAdCreatives(this.getPrefixedId(), context);
    }

    public APIRequestDeleteAdLabels deleteAdLabels() {
        return new APIRequestDeleteAdLabels(this.getPrefixedId(), context);
    }

    public APIRequestCreateAdLabel createAdLabel() {
        return new APIRequestCreateAdLabel(this.getPrefixedId(), context);
    }

    public APIRequestGetAdRulesGoverned getAdRulesGoverned() {
        return new APIRequestGetAdRulesGoverned(this.getPrefixedId(), context);
    }

    public APIRequestGetAds getAds() {
        return new APIRequestGetAds(this.getPrefixedId(), context);
    }

    public APIRequestGetAsyncAdRequests getAsyncAdRequests() {
        return new APIRequestGetAsyncAdRequests(this.getPrefixedId(), context);
    }
    ...
    public APIRequestGetCopies getCopies() {
        return new APIRequestGetCopies(this.getPrefixedId(), context);
    }

    public APIRequestCreateCopy createCopy() {
        return new APIRequestCreateCopy(this.getPrefixedId(), context);
    }

    public APIRequestGetDeliveryEstimate getDeliveryEstimate() {
        return new APIRequestGetDeliveryEstimate(this.getPrefixedId(), context);
    }

    public APIRequestGetInsights getInsights() {
        return new APIRequestGetInsights(this.getPrefixedId(), context);
    }

    public APIRequestGetInsightsAsync getInsightsAsync() {
        return new APIRequestGetInsightsAsync(this.getPrefixedId(), context);
    }

    public APIRequestGetTargetingSentenceLines getTargetingSentenceLines() {
        return new APIRequestGetTargetingSentenceLines(this.getPrefixedId(), context);
    }
    ...
    public AdSet setFieldAdsetSchedule(String value) {
        Type type = new TypeToken<List<DayPart>>() {
        }.getType();
    ...
    public AdSet setFieldAttributionSpec(String value) {
        Type type = new TypeToken<List<AttributionSpec>>() {
        }.getType();
    ...
    public AdSet setFieldBidAdjustments(String value) {
        Type type = new TypeToken<AdBidAdjustments>() {
        }.getType();
    ...
    public AdSet setFieldBidConstraints(String value) {
        Type type = new TypeToken<AdCampaignBidConstraint>() {
        }.getType();
    ...
    public AdSet setFieldCampaign(String value) {
        Type type = new TypeToken<Campaign>() {
        }.getType();
    ...
    public AdSet setFieldFrequencyControlSpecs(String value) {
        Type type = new TypeToken<List<AdCampaignFrequencyControlSpecs>>() {
        }.getType();
    ...
    public AdSet setFieldIssuesInfo(String value) {
        Type type = new TypeToken<List<AdCampaignIssuesInfo>>() {
        }.getType();
    ...
    public AdSet setFieldLearningStageInfo(String value) {
        Type type = new TypeToken<AdCampaignLearningStageInfo>() {
        }.getType();
    ...
    public AdSet setFieldPromotedObject(String value) {
        Type type = new TypeToken<AdPromotedObject>() {
        }.getType();
    ...
    public AdSet setFieldRecommendations(String value) {
        Type type = new TypeToken<List<AdRecommendation>>() {
        }.getType();
    ...
    public enum EnumConfiguredStatus {
        ...
        EnumConfiguredStatus(String value) {
            this.value = value;
        }
    ...
    public enum EnumEffectiveStatus {
        ...
        EnumEffectiveStatus(String value) {
            this.value = value;
        }
    ...
    public enum EnumOptimizationGoal {
        ...
        EnumOptimizationGoal(String value) {
            this.value = value;
        }
    ...
    public enum EnumExecutionOptions {
        ...
        EnumExecutionOptions(String value) {
            this.value = value;
        }
    ...
    public enum EnumFullFunnelExplorationMode {
        ...
        EnumFullFunnelExplorationMode(String value) {
            this.value = value;
        }
    ...
    public enum EnumMultiOptimizationGoalWeight {
        ...
        EnumMultiOptimizationGoalWeight(String value) {
            this.value = value;
        }
    ...
    public enum EnumOptimizationSubEvent {
        ...
        EnumOptimizationSubEvent(String value) {
            this.value = value;
        }
    ...
    public enum EnumTuneForCategory {
        ...
        EnumTuneForCategory(String value) {
            this.value = value;
        }
