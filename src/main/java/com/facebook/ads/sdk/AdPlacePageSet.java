...
public class AdPlacePageSet extends APINode {
    ...
    public AdPlacePageSet fetch() throws APIException {
        AdPlacePageSet newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public enum EnumLocationTypes {
        ...
        EnumLocationTypes(String value) {
            this.value = value;
        }
    ...
    public enum EnumTargetedAreaType {
        ...
        EnumTargetedAreaType(String value) {
            this.value = value;
        }
