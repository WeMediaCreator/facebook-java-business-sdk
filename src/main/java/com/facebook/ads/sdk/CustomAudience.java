...
public class CustomAudience extends APINode {
    ...
    public CustomAudience fetch() throws APIException {
        CustomAudience newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestDeleteAdAccounts deleteAdAccounts() {
        return new APIRequestDeleteAdAccounts(this.getPrefixedId(), context);
    }
    ...
    public APIRequestGetSessions getSessions() {
        return new APIRequestGetSessions(this.getPrefixedId(), context);
    }

    public APIRequestGetSharedAccountInfo getSharedAccountInfo() {
        return new APIRequestGetSharedAccountInfo(this.getPrefixedId(), context);
    }

    public APIRequestDeleteUsers deleteUsers() {
        return new APIRequestDeleteUsers(this.getPrefixedId(), context);
    }

    public APIRequestCreateUser createUser() {
        return new APIRequestCreateUser(this.getPrefixedId(), context);
    }
    ...
    public enum EnumClaimObjective {
        ...
        EnumClaimObjective(String value) {
            this.value = value;
        }
    ...
    public enum EnumCustomerFileSource {
        ...
        EnumCustomerFileSource(String value) {
            this.value = value;
        }
