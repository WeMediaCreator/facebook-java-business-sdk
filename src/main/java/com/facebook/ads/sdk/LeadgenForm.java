...
public class LeadgenForm extends APINode {
    ...
    public LeadgenForm fetch() throws APIException {
        LeadgenForm newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestGetTestLeads getTestLeads() {
        return new APIRequestGetTestLeads(this.getPrefixedId(), context);
    }

    public APIRequestCreateTestLead createTestLead() {
        return new APIRequestCreateTestLead(this.getPrefixedId(), context);
    }
