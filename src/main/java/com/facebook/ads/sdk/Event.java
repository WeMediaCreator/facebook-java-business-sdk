...
public class Event extends APINode {
    ...
    public Event fetch() throws APIException {
        Event newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestGetFeed getFeed() {
        return new APIRequestGetFeed(this.getPrefixedId(), context);
    }
    ...
    public APIRequestGetPosts getPosts() {
        return new APIRequestGetPosts(this.getPrefixedId(), context);
    }
    ...
    public enum EnumOnlineEventFormat {
        ...
        EnumOnlineEventFormat(String value) {
            this.value = value;
        }
    ...
    public enum EnumEventStateFilter {
        ...
        EnumEventStateFilter(String value) {
            this.value = value;
        }
