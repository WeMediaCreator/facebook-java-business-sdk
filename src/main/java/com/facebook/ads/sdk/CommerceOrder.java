...
public class CommerceOrder extends APINode {
    ...
    public CommerceOrder fetch() throws APIException {
        CommerceOrder newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestCreateAcknowledgeOrder createAcknowledgeOrder() {
        return new APIRequestCreateAcknowledgeOrder(this.getPrefixedId(), context);
    }

    public APIRequestGetCancellations getCancellations() {
        return new APIRequestGetCancellations(this.getPrefixedId(), context);
    }

    public APIRequestCreateCancellation createCancellation() {
        return new APIRequestCreateCancellation(this.getPrefixedId(), context);
    }

    public APIRequestGetItems getItems() {
        return new APIRequestGetItems(this.getPrefixedId(), context);
    }

    public APIRequestGetPayments getPayments() {
        return new APIRequestGetPayments(this.getPrefixedId(), context);
    }

    public APIRequestGetPromotionDetails getPromotionDetails() {
        return new APIRequestGetPromotionDetails(this.getPrefixedId(), context);
    }

    public APIRequestGetPromotions getPromotions() {
        return new APIRequestGetPromotions(this.getPrefixedId(), context);
    }

    public APIRequestGetRefunds getRefunds() {
        return new APIRequestGetRefunds(this.getPrefixedId(), context);
    }

    public APIRequestCreateRefund createRefund() {
        return new APIRequestCreateRefund(this.getPrefixedId(), context);
    }
    ...
    public APIRequestGetShipments getShipments() {
        return new APIRequestGetShipments(this.getPrefixedId(), context);
    }

    public APIRequestCreateShipment createShipment() {
        return new APIRequestCreateShipment(this.getPrefixedId(), context);
    }

    public APIRequestCreateUpdateShipment createUpdateShipment() {
        return new APIRequestCreateUpdateShipment(this.getPrefixedId(), context);
    }
