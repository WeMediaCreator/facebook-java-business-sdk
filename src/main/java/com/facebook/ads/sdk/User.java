...
public class User extends APINode {
    ...
    public User fetch() throws APIException {
        User newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestDeleteAccessTokens deleteAccessTokens() {
        return new APIRequestDeleteAccessTokens(this.getPrefixedId(), context);
    }
    ...
    public APIRequestGetAdAccounts getAdAccounts() {
        return new APIRequestGetAdAccounts(this.getPrefixedId(), context);
    }

    public APIRequestGetAlbums getAlbums() {
        return new APIRequestGetAlbums(this.getPrefixedId(), context);
    }

    public APIRequestCreateApplication createApplication() {
        return new APIRequestCreateApplication(this.getPrefixedId(), context);
    }

    public APIRequestGetAppRequestFormerRecipients getAppRequestFormerRecipients() {
        return new APIRequestGetAppRequestFormerRecipients(this.getPrefixedId(), context);
    }

    public APIRequestGetAppRequests getAppRequests() {
        return new APIRequestGetAppRequests(this.getPrefixedId(), context);
    }

    public APIRequestGetAssignedAdAccounts getAssignedAdAccounts() {
        return new APIRequestGetAssignedAdAccounts(this.getPrefixedId(), context);
    }

    public APIRequestGetAssignedBusinessAssetGroups getAssignedBusinessAssetGroups() {
        return new APIRequestGetAssignedBusinessAssetGroups(this.getPrefixedId(), context);
    }

    public APIRequestGetAssignedPages getAssignedPages() {
        return new APIRequestGetAssignedPages(this.getPrefixedId(), context);
    }

    public APIRequestGetAssignedProductCatalogs getAssignedProductCatalogs() {
        return new APIRequestGetAssignedProductCatalogs(this.getPrefixedId(), context);
    }
    ...
    public APIRequestDeleteBusinesses deleteBusinesses() {
        return new APIRequestDeleteBusinesses(this.getPrefixedId(), context);
    }

    public APIRequestGetBusinesses getBusinesses() {
        return new APIRequestGetBusinesses(this.getPrefixedId(), context);
    }

    public APIRequestCreateBusiness createBusiness() {
        return new APIRequestCreateBusiness(this.getPrefixedId(), context);
    }

    public APIRequestGetConversations getConversations() {
        return new APIRequestGetConversations(this.getPrefixedId(), context);
    }

    public APIRequestGetCustomLabels getCustomLabels() {
        return new APIRequestGetCustomLabels(this.getPrefixedId(), context);
    }
    ...
    public APIRequestCreateFeed createFeed() {
        return new APIRequestCreateFeed(this.getPrefixedId(), context);
    }

    public APIRequestGetFriends getFriends() {
        return new APIRequestGetFriends(this.getPrefixedId(), context);
    }

    public APIRequestCreateGameItem createGameItem() {
        return new APIRequestCreateGameItem(this.getPrefixedId(), context);
    }

    public APIRequestCreateGameTime createGameTime() {
        return new APIRequestCreateGameTime(this.getPrefixedId(), context);
    }

    public APIRequestCreateGamesPlay createGamesPlay() {
        return new APIRequestCreateGamesPlay(this.getPrefixedId(), context);
    }

    public APIRequestGetGroups getGroups() {
        return new APIRequestGetGroups(this.getPrefixedId(), context);
    }

    public APIRequestGetIdsForApps getIdsForApps() {
        return new APIRequestGetIdsForApps(this.getPrefixedId(), context);
    }

    public APIRequestGetIdsForBusiness getIdsForBusiness() {
        return new APIRequestGetIdsForBusiness(this.getPrefixedId(), context);
    }

    public APIRequestGetIdsForPages getIdsForPages() {
        return new APIRequestGetIdsForPages(this.getPrefixedId(), context);
    }

    public APIRequestGetLikes getLikes() {
        return new APIRequestGetLikes(this.getPrefixedId(), context);
    }

    public APIRequestGetLiveEncoders getLiveEncoders() {
        return new APIRequestGetLiveEncoders(this.getPrefixedId(), context);
    }

    public APIRequestCreateLiveEncoder createLiveEncoder() {
        return new APIRequestCreateLiveEncoder(this.getPrefixedId(), context);
    }
    ...
    public APIRequestCreateLiveVideo createLiveVideo() {
        return new APIRequestCreateLiveVideo(this.getPrefixedId(), context);
    }

    public APIRequestGetMusic getMusic() {
        return new APIRequestGetMusic(this.getPrefixedId(), context);
    }

    public APIRequestCreateNotification createNotification() {
        return new APIRequestCreateNotification(this.getPrefixedId(), context);
    }
    ...
    public APIRequestDeletePermissions deletePermissions() {
        return new APIRequestDeletePermissions(this.getPrefixedId(), context);
    }
    ...
    public APIRequestGetPersonalAdAccounts getPersonalAdAccounts() {
        return new APIRequestGetPersonalAdAccounts(this.getPrefixedId(), context);
    }

    public APIRequestGetPhotos getPhotos() {
        return new APIRequestGetPhotos(this.getPrefixedId(), context);
    }

    public APIRequestCreatePhoto createPhoto() {
        return new APIRequestCreatePhoto(this.getPrefixedId(), context);
    }
    ...
    public APIRequestGetRichMediaDocuments getRichMediaDocuments() {
        return new APIRequestGetRichMediaDocuments(this.getPrefixedId(), context);
    }

    public APIRequestCreateStagingResource createStagingResource() {
        return new APIRequestCreateStagingResource(this.getPrefixedId(), context);
    }

    public APIRequestGetVideos getVideos() {
        return new APIRequestGetVideos(this.getPrefixedId(), context);
    }

    public APIRequestCreateVideo createVideo() {
        return new APIRequestCreateVideo(this.getPrefixedId(), context);
    }

    public APIRequestDelete delete() {
        return new APIRequestDelete(this.getPrefixedId(), context);
    }
    ...
    public enum EnumLocalNewsMegaphoneDismissStatus {
        ...
        EnumLocalNewsMegaphoneDismissStatus(String value) {
            this.value = value;
        }
    ...
    public enum EnumLocalNewsSubscriptionStatus {
        ...
        EnumLocalNewsSubscriptionStatus(String value) {
            this.value = value;
        }
    ...
    public enum EnumBackdatedTimeGranularity {
        ...
        EnumBackdatedTimeGranularity(String value) {
            this.value = value;
        }
    ...
    public enum EnumCheckinEntryPoint {
        ...
        EnumCheckinEntryPoint(String value) {
            this.value = value;
        }
    ...
    public enum EnumPlaceAttachmentSetting {
        ...
        EnumPlaceAttachmentSetting(String value) {
            this.value = value;
        }
    ...
    public enum EnumPostSurfacesBlacklist {
        ...
        EnumPostSurfacesBlacklist(String value) {
            this.value = value;
        }
    ...
    public enum EnumPostingToRedspace {
        ...
        EnumPostingToRedspace(String value) {
            this.value = value;
        }
    ...
    public enum EnumTargetSurface {
        ...
        EnumTargetSurface(String value) {
            this.value = value;
        }
    ...
    public enum EnumUnpublishedContentType {
        ...
        EnumUnpublishedContentType(String value) {
            this.value = value;
        }
