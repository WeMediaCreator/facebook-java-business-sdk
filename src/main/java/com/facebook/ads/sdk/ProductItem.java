...
public class ProductItem extends APINode {
    ...
    public ProductItem fetch() throws APIException {
        ProductItem newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public enum EnumShippingWeightUnit {
        ...
        EnumShippingWeightUnit(String value) {
            this.value = value;
        }
    ...
    public enum EnumCommerceTaxCategory {
        ...
        EnumCommerceTaxCategory(String value) {
            this.value = value;
        }
