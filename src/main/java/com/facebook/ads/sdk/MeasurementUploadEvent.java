...
public class MeasurementUploadEvent extends APINode {
    ...
    public MeasurementUploadEvent fetch() throws APIException {
        MeasurementUploadEvent newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public enum EnumAggregationLevel {
        ...
        EnumAggregationLevel(String value) {
            this.value = value;
        }
    ...
    public enum EnumLookbackWindow {
        ...
        EnumLookbackWindow(String value) {
            this.value = value;
        }
    ...
    public enum EnumMatchUniverse {
        ...
        EnumMatchUniverse(String value) {
            this.value = value;
        }
