...
public class Campaign extends APINode {
    ...
    public Campaign fetch() throws APIException {
        Campaign newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestGetAdSets getAdSets() {
        return new APIRequestGetAdSets(this.getPrefixedId(), context);
    }
    ...
    public enum EnumSpecialAdCategories {
        ...
        EnumSpecialAdCategories(String value) {
            this.value = value;
        }
    ...
    public enum EnumSpecialAdCategoryCountry {
        ...
        EnumSpecialAdCategoryCountry(String value) {
            this.value = value;
        }
    ...
    public enum EnumSpecialAdCategory {
        ...
        EnumSpecialAdCategory(String value) {
            this.value = value;
        }
