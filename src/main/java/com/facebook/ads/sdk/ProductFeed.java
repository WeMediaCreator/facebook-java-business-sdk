...
public class ProductFeed extends APINode {
    ...
    public ProductFeed fetch() throws APIException {
        ProductFeed newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestGetRules getRules() {
        return new APIRequestGetRules(this.getPrefixedId(), context);
    }

    public APIRequestCreateRule createRule() {
        return new APIRequestCreateRule(this.getPrefixedId(), context);
    }

    public APIRequestGetUploadSchedules getUploadSchedules() {
        return new APIRequestGetUploadSchedules(this.getPrefixedId(), context);
    }

    public APIRequestCreateUploadSchedule createUploadSchedule() {
        return new APIRequestCreateUploadSchedule(this.getPrefixedId(), context);
    }

    public APIRequestGetUploads getUploads() {
        return new APIRequestGetUploads(this.getPrefixedId(), context);
    }
    ...
    public enum EnumQuotedFieldsMode {
        ...
        EnumQuotedFieldsMode(String value) {
            this.value = value;
        }
