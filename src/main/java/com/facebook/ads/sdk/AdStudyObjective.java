...
public class AdStudyObjective extends APINode {
    ...
    public AdStudyObjective fetch() throws APIException {
        AdStudyObjective newInstance = fetchById(this.getPrefixedId(), this.context);
    ...
    public APIRequestGetAdPlacePageSets getAdPlacePageSets() {
        return new APIRequestGetAdPlacePageSets(this.getPrefixedId(), context);
    }
    ...
    public APIRequestGetApplications getApplications() {
        return new APIRequestGetApplications(this.getPrefixedId(), context);
    }
    ...
    public APIRequestGetOffsitePixels getOffsitePixels() {
        return new APIRequestGetOffsitePixels(this.getPrefixedId(), context);
    }

    public APIRequestGetPartnerStudies getPartnerStudies() {
        return new APIRequestGetPartnerStudies(this.getPrefixedId(), context);
    }
